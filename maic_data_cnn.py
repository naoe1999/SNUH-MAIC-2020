...
# test set 로딩
if os.path.exists('./data/x_test.npz'):
    print('loading test...', flush=True, end='')
    x_test = np.load('./data/x_test.npz')['arr_0']
    print('done', flush=True)
else:
    x_test = pd.read_csv('./data/test2_x.csv').values
